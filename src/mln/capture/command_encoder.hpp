...
// Internal to mbgl-core: this header reaches src/mln/gfx/{render_pass,upload_pass}.hpp,
// which are not installed. Consumers of the capture backend only need
// <mln/capture/renderer_backend.hpp> and <mln/capture/frame_diff.hpp>.

#include <mln/capture/renderable.hpp>
